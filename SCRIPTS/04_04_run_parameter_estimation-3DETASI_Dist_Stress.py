...
'''
This code estimates 3D ETASI parameters by considering distance to the fault 
...
##====== 3D ETASI+(Distance to fault plane)+Stress parameter estimation =======
for i in range(4, 5):             ## Here we just chose Baja California 
    ...
    print('\n\t Estimation of 3D ETASI + R + %s parameter for %s sequence' % (stressvalue, name))
